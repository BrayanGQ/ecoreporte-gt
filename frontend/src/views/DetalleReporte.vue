...
<template>
  <div class="container">
    ...
    <div v-if="reporte">
      <h1 class="title">Reporte {{ reporte.codigo_seguimiento }}</h1>
...
<style scoped>
.volver { color: var(--forest); cursor: pointer; font-size: 13px; display: inline-block; margin-bottom: 14px; }
.volver:hover { text-decoration: underline; }
.grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
.card h3 { color: var(--forest); font-size: 15px; margin-bottom: 12px; }
.card p { margin: 7px 0; font-size: 14px; }
